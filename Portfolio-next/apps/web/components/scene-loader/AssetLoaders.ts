...
function findDesk(scene: Object3D): Object3D | null {
  ...
  scene.traverse((o: Object3D) => { if ((o as any).name === "Desk") { desk = o; } });
  return desk;
}
...
export function MonitorLoader(): AssetLoader {
  ...
  function builder(context: AssetManagerContext): OptionalUpdateAction {
    ...
    // Create a placeholder until desktop deployment is fixed
    ...
    placeholder.innerHTML = `
      <div>
        ...
        <p style="margin: 10px 0 0 0; color: #666; font-size: 14px;">Desktop app loading...</p>
      </div>
    `;
