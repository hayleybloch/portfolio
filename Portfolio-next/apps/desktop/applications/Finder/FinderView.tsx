      ...
      <div className={styles.content}>
        <div className={styles.locations}>
          ...
          <ul>
            ...
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/hayley/'); }}>Home</button></li>
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/hayley/Desktop/'); }}>Desktop</button></li>
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/hayley/Documents'); }}>Documents</button></li>
          </ul>
        </div>
